...
int main(int argc, char** argv)
{
    ...
    {
        printf("Test failed for not awarding player correct number of actions for one action card.\n");
    }
