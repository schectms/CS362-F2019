    ...
    if (choice1 > 0) { //Boolean true or going to discard an estate
        ...
        while(card_not_discarded) {
            if (state->hand[currentPlayer][p] == estate) { //Found an estate card!
                ...
                gainEstateBaron(state, currentPlayer);
                card_not_discarded = 0;//Exit the loop
            }
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    case mine:
        cardEffectMine(choice1, choice2, state, handPos, currentPlayer);
    ...
    case baron:
        cardEffectBaron(choice1, state, currentPlayer);
    ...
    case minion:
        cardEffectMinion(choice1, choice2, state, handPos, currentPlayer);
    ...
    case tribute:
        cardEffectTribute(state, currentPlayer, nextPlayer, tributeRevealedCards);

    case ambassador:
        cardEffectAmbassador(choice1, choice2, state, handPos, currentPlayer);
