...
int playAmbassador(int choice2, int choice1, int handPos, struct gameState* state, int currentPlayer)
{
	int i;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState* state, int handPos, int* bonus)
{
	...
	case minion:
		playMinion(state, handPos, currentPlayer, choice1, choice2);
		break;
	...
	case ambassador:
		playAmbassador(choice2, choice1, handPos, state, currentPlayer);
		break;
